...
* Inserted R script with code into an R markdown document to display findings and a summary.
...
* The final project not only allowed me to research a topic I am passionate about, but provided me the platform to refine my programming and GIS skills.
...
* This rigorous program allowed me to improve on my research, presentation and writing skills, as well as, further develop critical thinking and analyze the complex intersection of big data and privacy.
